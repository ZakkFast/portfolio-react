    ...
    <div name="work" className="w-full md:h-screen text-[#333] bg-[#9bc1bc]">
      ...
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          ...
          <p className="py-6">
            Here is some of my recent work. Hover over to see more!
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://62c52daefe33732e5980af94--creative-axolotl-4a6607.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                ...
                <a
                  href="https://github.com/ZakkFast/react-expense-tracker"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
